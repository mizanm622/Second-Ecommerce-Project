...
@endphp
<div class="cart_section"><!--Start sSection-->
    <div class="container">
        <div class="row">
            <div class="col">
                @if ($wishlistCount == 0)
            ...
            <div class="col-lg-12 offset-lg-1">
                <div class="cart_container"><!--Wishlist Container-->
                    <div class="cart_title">Your Wishlists</div>
                        @foreach ($wishlists as $product)
                            ...
                            <div class="cart_items" id="wishlist-item"><!--Wishlist Items-->
                                <ul class="cart_list">
                                    <li class="cart_item clearfix">
                                        ...
                                        <div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
                                            ...
                                            <div class="cart_item_price cart_info_col"><!--Product Price-->
                                            ...
                                            <div class="cart_item_quantity cart_info_col"><!--Added Date-->
                            ...
                            </div><!--End Wishlist Items-->
                        @endforeach
                    <div class="cart_buttons"><!--Wishlist button-->
