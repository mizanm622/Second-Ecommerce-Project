...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card">
      <h4 class="fw-bold text-center bg-dark text-light py-2">Tracking Orders</h4>

      <h5 class="card-header">
          @if (count($address) ==0)
          <h4 class="m-auto">No Tracking Orders Found here........</h4>
           @endif
          ...
          <button type="button" class="btn btn-primary btn-block" data-bs-toggle="modal" data-bs-target="#id{{$items->id}}">
              <div class=""> <span class="text-left col-4"> Order : #{{$loop->iteration}}</span> Status:<span class="text-center col-4">{!!$items->tracking == 0 ? '<i class="fa fa-spinner fa-spin" style="font-size:24px;color:red"></i>' : '<i class="fa fa-check" style="font-size:24px;color:green"></i>'!!}</span>Date:<span class="text-right col-4"> {{$items->order_date}}</span></div>
          </button>
