                                        ...
                                        <table class="table" id="data-table"><!--Product table-->
                                            ...
                                            <tbody>
                                                ...
                                                <div class="address"><!--Shipping address-->
                                                    ...
                                                    <p class="text-dark">   Phone:<span>{{$items->phone}}</span></p>
                                                    <p class="text-dark">   Email:<span>{{$items->email}}</span></p>
                                                    <p class="text-dark"> Address:<span>{{$items->address}}</span></p>
                                                    <p class="text-dark">    Town:<span>{{$items->town}}</span></p>
                                                    <p class="text-dark">    City:<span>{{$items->city}}</span></p>
                                                    <p class="text-dark">Zip Code:<span>{{$items->zip}}</span></p>
                                                    <p class="text-dark"> Country:<span>{{$items->country}}</span></p>
                                                    <p class="text-dark"> Order Status:<span class="text-center col-4">{!!$items->status == 0 ? '<i class="fa fa-spinner fa-spin" style="font-size:24px;color:red"></i>' : '<i class="fa fa-check" style="font-size:24px;color:green"></i>'!!}</span></p>
